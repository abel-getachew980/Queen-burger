    ...
    reviews: {
      ...
      list: [
        ...
        },
        {
          ...
          source: 'Google Maps Review',
          rating: 5,
          text: "I visited with my siblings and had such an amazing experience! The food was full of flavor, perfectly seasoned, with a soft bun, crispy chips, and delicious sauces. The space is cozy, the waiters are attentive and the food doesn’t take long to arrive. I might even crown this as one of my favorite burger spots.",
        },
        {
          id: 3,
          isGuide: true,
          ...
          source: 'Google Maps Review',
          rating: 5,
          text: "I've eaten here three times now, and the Majestic Cheeseburger is honestly one of the best burgers I've had. It's juicy, flavorful, and the kind of burger that has you thinking about it on the drive home and looking forward to the next time you can have it. Highly recommended.",
        },
        {
          id: 4,
          isGuide: false,
          name: 'Brook Tadesse',
          badge: 'Verified Diner · 4 reviews',
          date: '3 weeks ago',
          source: 'Google Maps Review',
          rating: 5,
          text: "Hands down the tastiest smash burgers in Addis Ababa! The Queen Lava burger with the crispy fried onion ring and spicy sauce is out of this world. Great vibes and friendly customer care.",
        },
        {
          id: 5,
          isGuide: false,
          name: 'Helen Mekonnen',
          badge: 'Verified Customer · 2 reviews',
          date: '2 weeks ago',
          source: 'Google Maps Review',
          rating: 5,
          text: "The Philly Cheese Steak sandwich and Waffle Fries are exceptional. Love the royal theme, clean dining area, and quick takeout packaging. Mekanisa branch is my top weekend recommendation!",
        },
        {
          id: 6,
          isGuide: false,
          name: 'Yonas Kebede',
          badge: 'Verified Diner · 5 reviews',
          date: '1 month ago',
          source: 'Google Maps Review',
          rating: 5,
          text: "The smashed double beef patties have that authentic caramelized crust with melted provolone. Butter-toasted buns are so soft. Definitely worth every bite!",
        }
      ]
    },
    social: {
      ...
      list: [
        {
          ...
          rating: 5,
          text: "ማጀስቲክ ቺዝ በርገር እና ኸር ማጀስቲን ሞክረናል። ማጀስቲክ ቺዝ በርገሩ በጣም ጁሲ (juicy) እና ከኸር ማጀስቲ ይበልጥ የሚጣፍጥ ነው። ጁሲ የሆነ በርገር ከፈለጉ የመጀመሪያውን ይምረጡ፤ ኸር ማጀስቲ ደግሞ በጥሩ ሁኔታ የተዘጋጀ ነው። ሁለቱም በጣም የሚጣፍጡ ናቸው። ዋጋው እዚህ ከተለጠፈው ሜኑ ጋር ተመሳሳይ ነው።",
        },
        {
          id: 2,
          isGuide: true,
          ...
          source: 'የጉግል ካርታ አስተያየት',
          rating: 5,
          text: "ከወንድሞቼና እህቶቼ ጋር ጎብኝቼ በጣም ደስ የሚል ጊዜ አሳልፈናል! ምግቡ ጣዕም ያለው፣ በደንብ የተቀመመ፣ ለስላሳ ቡን፣ ቆጣጣ የድንች ጥብስና የሚጣፍጥ ሶስ አለው። ቦታው ምቹ ነው፤ አስተናጋጆቹ ፈጣንና ትኩረት የሚሰጡ ናቸው፣ ምግቡም ለመድረስ ብዙ አይቆይም። የበርገር ፍላጎቴን ለማርካት ከምወዳቸው ቦታዎች አንዱ አድርጌ ልሾመው እችላለሁ።",
        },
        {
          id: 3,
          isGuide: true,
          ...
          source: 'የጉግል ካርታ አስተያየት',
          rating: 5,
          text: "እዚህ ሶስት ጊዜ በልቻለሁ፤ ማጀስቲክ ቺዝበርገሩ በቅንነት ከተመገብኳቸው ምርጥ በርገሮች አንዱ ነው። ጁሲ፣ ጣዕም ያለው እና ወደ ቤት እየተመለሱ የሚያስቡትና ሌላ ጊዜ ለመብላት የሚጓጉለት ዓይነት በርገር ነው። የምግቡ ጥራት በጣም የሚያረካ ነው። በጣም የሚመከር።",
        },
        {
          id: 4,
          isGuide: false,
          name: 'ብሩክ ታደሰ (Brook Tadesse)',
          badge: 'የተረጋገጠ ደንበኛ · 4 አስተያየቶች',
          date: 'ከ3 ሳምንታት በፊት',
          source: 'የጉግል ካርታ አስተያየት',
          rating: 5,
          text: "በአዲስ አበባ ካሉ ምርጥ የስማሽ በርገር ቦታዎች አንዱ! ዘ ኪን ላቫ በርገር ከተጠበሰ የሽንኩርት ቀለበት እና የሚያቃጥል ሶስ ጋር በጣም ልዩ ጣዕም አለው። ሰራተኞቹም በጣም ተግባቢ ናቸው።",
        },
        {
          id: 5,
          isGuide: false,
          name: 'ሄለን መኮንን (Helen Mekonnen)',
          badge: 'የተረጋገጠ ደንበኛ · 2 አስተያየቶች',
          date: 'ከ2 ሳምንታት በፊት',
          source: 'የጉግል ካርታ አስተያየት',
          rating: 5,
          text: "ፊሊ ቺዝ ስቴክ ሳንድዊቹ እና ዋፍል ፍራይሱ እጅግ በጣም ምርጥ ናቸው። ንግሥታዊ ድባብ፣ ንፅህና እና ፈጣን መስተንግዶ አላቸው። የመካኒሳ ቅርንጫፍ የሳምንቱ መጨረሻ ምርጫዬ ነው!",
        },
        {
          id: 6,
          isGuide: false,
          name: 'ዮናስ ከበደ (Yonas Kebede)',
          badge: 'የተረጋገጠ ደንበኛ · 5 አስተያየቶች',
          date: 'ከ1 ወር በፊት',
          source: 'የጉግል ካርታ አስተያየት',
          rating: 5,
          text: "በቅቤ የተጠበሰው ቡን በጣም ለስላሳ ሲሆን የስማሽ ፓቲው አበሳሰልና የፕሮቮሎን ቺዙ ቅይጥ ልዩ ጣዕም ይሰጣል። በእርግጥም መሞከር ያለበት ምርጥ በርገር ነው።",
        }
      ]
    },
    social: {
